...
# need to modify below for single IAA and GAD
#-------------------------------------------------------------------------------
...
single_iaa <- counts[counts$group == "Single IAA positive",]
single_iaa <- single_iaa[single_iaa$freq < 2,"Random_ID"]
single_gad <- counts[counts$group == "Single GAD positive",]
single_gad <- single_gad[single_gad$freq < 2,"Random_ID"]
single_other <- counts[counts$group == "Other single ab positive",]
single_other <- single_other[single_other$freq < 2,"Random_ID"]
