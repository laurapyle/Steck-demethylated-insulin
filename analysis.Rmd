...
alldata <- alldata[is.na(alldata$flag1),]
...
getdates$tab1_date <- pmax(getdates$Date_INS,getdates$Date_proins)
...
9) There were `r misspro` subjects who did not have any proinsulin ratio results who were excluded from analysis.  After that, there were an additional `r missins` subjects who did not have any unmethylated INS ratio results who were removed from analysis.  
