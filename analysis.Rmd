...
colnames(keep_long) <- c("Random_ID","Draw_Date","GAD65","GAD65H","ICA512","IA_2H","mIAA","ZnT8","ICA","ECL_GADA","ECL_IA2A","ECL_IAA","Proinsulin_pM_L","PEP0","HbA1c")
...
alldata$final.group[alldata$final.group==0] <- "Negative"
alldata$final.group[alldata$final.group==1] <- "Single ab positive"
alldata$final.group[alldata$final.group==2] <- "Multiple ab positive"
alldata$final.group[alldata$final.group==3] <- "T1D"
...
View(alldata[c("final.group","group2")])
