...
length(unique(t1d_select_pro$Random_ID))
# lose 5 people if we require pro_pep within 2 months (same for 3 months)
...
length(unique(t1d_select_ins$Random_ID))
# lose 5 people if we require INS ratio within 2 months
...
allpro <- rbind(t1d_select_pro,neg_select_pro,mult_select_pro,sing_select_pro)
# combine the results for the INS analysis
allins <- rbind(t1d_select_ins,neg_select_ins,mult_select_ins,sing_select_ins)
