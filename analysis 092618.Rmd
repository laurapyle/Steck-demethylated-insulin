...
tab_ins <- final_table(allins,'U_MplusU_Ratio_Zen',group=as.factor(allins$final.group),margin=2,single=0,ron=2)
...
+ Otherwise, they were classifed as antibody negative.
