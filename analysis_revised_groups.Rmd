...
Table 8 shows the results of the mixed model testing whether the groups differ in the trajectories of proinsulin ratios over time, after adjusting for sex, age, and BMI.  The trajectories in the two groups were not significantly different (p=`r mixt_adj[3,4]`).
