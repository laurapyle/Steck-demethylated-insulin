...
Table 4 shows the results of the logistic regression testing whether the earliest proinsulin ratio predicts T1D.
...
Table 5 shows the results of the logistic regression testing whether the earliest proinsulin ratio predicts IGTT.
...
Table 6 shows the results of the mixed model testing whether the groups differ in the trajectories of proinsulin ratios over time.  The trajectories in the two groups were not significantly different (p=`r mixt[4,4]`).
