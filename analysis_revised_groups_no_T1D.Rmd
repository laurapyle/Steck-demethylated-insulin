...
# for this version of the report, remove T1D group
alldata <- alldata[alldata$final.group != "T1D",]
tab1data <- tab1data[tab1data$final.group != "T1D",]
allpro <- allpro[allpro$final.group != "T1D",]
